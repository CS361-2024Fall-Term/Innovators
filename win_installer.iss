...
Source: "dist\Innovators\icon.ico"; DestDir: "{app}"; Flags: ignoreversion
...
[Icons]
Name: "{group}\EasyCal"; Filename: "{app}\main.exe"; IconFilename: "{app}\icon.ico"
Name: "{group}\Uninstall"; Filename: "uninstall.exe"
Name: "{userdesktop}\EasyCal"; Filename: "{app}\EasyCal.exe"; IconFilename: "{app}\icon.ico"; WorkingDir: "{app}"; Tasks: desktopicon
